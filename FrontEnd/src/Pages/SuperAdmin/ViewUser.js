...
export default function ViewProfileA()
{
    ...
    return (
        <div>
            ...
            <div className="main-panel">
              <Navbar id={userLogged._id} image={userLogged.image} username={user.username}  ></Navbar> 
              ...
              <div class="card-body">
                <div class="col-lg-14">
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder text-dark">Role:</h5><p class="mb-1 pt-2 text-bold text-dark">{role}</p>
